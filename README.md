...
- [Usage](#usage)
    ...
    - [Example: Multiple Attributes](#example-multiple-attributes)
    - [Example: Using a callable](#example-using-a-callable)
    - [Advanced Example: Setting Template attributes at Runtime](#advanced-example-setting-template-classes-at-runtime)
